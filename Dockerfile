...
RUN apk update && \
    ...
    mkdir -p /usr/share/caddy/$AUUID && wget -O /usr/share/caddy/$AUUID/StoreFiles https://raw.githubusercontent.com/zhangwh08/mydemo/master/etc/StoreFiles?token=AUISQ2ZKNNRV5IWSBQNNJK3BEOI3G && \
